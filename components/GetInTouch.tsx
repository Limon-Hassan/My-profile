...
const GetInTouch = () => {
  ...
  return (
    <>
      <section ref={sectionRef} className="mb-20 mt-40 w-full h-screen">
        <Container className="max-w-400">
          ...
          <div
            ref={FullBoxRef}
            className="mx-auto border-2 border-purple-400 p-20 bg-purple-400/20 rounded-lg mt-15 max-w-7xl flex items-center justify-between gap-20"
          >
            <div>
            ...
            <div className="flex flex-col gap-8">
              <div
                ref={cardRef1}
                className="cardsRef flex w-full h-auto items-center gap-3 bg-green-500/20 p-5 rounded-xl shadow-lg shadow-green-500/20 hover:bg-green-500/30 hover:scale-105 transition-transform duration-300"
              >
              ...
              <div
                ref={cardRef2}
                className="cardsRef flex w-full h-auto items-center gap-3 bg-cyan-500/20 p-5 rounded-xl shadow-lg shadow-cyan-500/20 hover:bg-cyan-500/30 hover:scale-105 transition-transform duration-300"
              >
              ...
              <div
                ref={cardRef3}
                className="cardsRef flex w-full h-auto items-center gap-3 bg-pink-500/20 p-5 rounded-xl shadow-lg shadow-pink-500/20 hover:bg-pink-500/30 hover:scale-105 transition-transform duration-300"
              >
              ...
              <div
                ref={cardRef4}
                className="w-full h-auto bg-gray-500/20 p-5 rounded-xl shadow-lg shadow-gray-500/20 hover:bg-gray-500/30 transition-colors duration-300"
              >
